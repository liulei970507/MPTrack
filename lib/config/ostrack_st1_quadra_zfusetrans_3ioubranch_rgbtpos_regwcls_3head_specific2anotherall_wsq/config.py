...
cfg.TEST.UPDATE_INTERVALS.LASHER = [200]
cfg.TEST.UPDATE_INTERVALS.RGBT210 = [50]
cfg.TEST.UPDATE_INTERVALS.RGBT234 = [50]
cfg.TEST.UPDATE_INTERVALS.GTOT = [50]
cfg.TEST.UPDATE_INTERVALS.VTUAV = [50]
cfg.TEST.UPDATE_THRESHOLD = edict()
cfg.TEST.UPDATE_THRESHOLD.LASHER = [0.75]
cfg.TEST.UPDATE_THRESHOLD.RGBT210 = [0.75]
cfg.TEST.UPDATE_THRESHOLD.RGBT234 = [0.75]
cfg.TEST.UPDATE_THRESHOLD.GTOT = [0.5]
cfg.TEST.UPDATE_THRESHOLD.VTUAV = [0.5]

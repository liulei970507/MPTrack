    ...
    def getitem(self):
        ...
        while not valid:
            ...
            try:
                ...
                # import pdb
                # pdb.set_trace()
                template_frames, template_anno = dataset.get_frames(seq_id, template_frame_ids, seq_info_dict)
                search_frames, search_anno = dataset.get_frames(seq_id, search_frame_ids, seq_info_dict)
